...
$order_number = rand(100000000, 900000000);
if(isset($_COOKIE['order_number'])) {
  $order_number = $_COOKIE['order_number'];
  setcookie('order_number', '', -1, '/');
  setcookie('order_number', $order_number, time() + 86400, '/');
}else {
  setcookie('order_number', $order_number, time() + 86400, '/');
}
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="payment-confirmation-box">
            <h1 class="cart-main-title">Payment Confirmation</h1>
            <div class="confirmation-message">
              ...
              <br />
              <h4>
                <strong style="color: #fd7140">Order Number:</strong> <?= $order_number; ?>
              </h4>
              <h4
                ><strong style="color: #fd7140">Amount Paid:</strong> $<?= $_GET['amount']; ?></h4
              >
            </div>
          </div>
        </div>
